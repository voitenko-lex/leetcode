...
class Solution:
    ...
    #             #  both in result_dict
    #             if (pair[1] in result_dict.keys()):
    #                 # conflict
    #                 if result_dict[pair[0]] == result_dict[pair[1]]:
    #                     print(result_dict)
    #                     return False
    #                 else:
    #                     continue
    #             else:
    #                 result_dict[pair[1]] = not result_dict[pair[0]]
    #         elif pair[1] in result_dict.keys():
    #             result_dict[pair[0]] = not result_dict[pair[1]]
    #         else:
    #             result_dict[pair[0]] = True
    #             result_dict[pair[1]] = False
    #     else:
    #         print(result_dict)
    #         return True
...
class TestMethods(unittest.TestCase):
    ...
    def test_sample00(self):
        self.assertEqual(True, self.sol.possibleBipartition(N = 4, dislikes = [[1,2],[1,3],[2,4]]))

    def test_sample01(self):
        self.assertEqual(False, self.sol.possibleBipartition(N = 3, dislikes = [[1,2],[1,3],[2,3]]))
